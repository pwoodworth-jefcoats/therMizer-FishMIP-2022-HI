...
This script is used to prepare the fishing forcing using the data provided from the FishMIP coordinators (as opposed to the data provided on the ISIMIP server).
...
### Need to select by SAUP country code, too ###
...
Average effort across years 1995 - 2004 (start year per [Woodworth-Jefcoats et al. 2019](https://doi.org/10.3389/fmars.2019.00383) end year per protocol).  This will equate to F = 0.2.  Scale the other time points accordingly.

``` {r}

# Determine 1995 - 2004 average
Baseline_idx <- which(HI_ann_NomActive[,1] >= 1995 & HI_ann_NomActive[,1] <= 2004)
Baseline_NomActive <- HI_ann_NomActive[Baseline_idx,2]
