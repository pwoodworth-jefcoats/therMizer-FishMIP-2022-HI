...
Need to check:   
* plankton forcings in comparison to previous GFDL forcing, slopes and intercept
  + Slopes are shallower and intercepts are greater (though intercepts are scaled the same as in previous round).  
  + Intentional differences in how plankton were aggregated  
* F in comparison to previous round  
  + Effort higher this round, over twice as high at some time steps
