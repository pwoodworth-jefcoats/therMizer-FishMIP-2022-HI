...
This workflow happens in [R](https://www.r-project.org/), with the exception of using [PyFerret](https://ferret.pmel.noaa.gov/Ferret/) to determine the domain area.  
